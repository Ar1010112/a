...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(ellipse_at_top_left,_#111827_0%,_#0a0e1a_70%)] text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
          <div className="flex justify-between items-center">
            <motion.h1
              ...
              className="text-5xl font-extrabold bg-gradient-to-r from-[#07D348] to-emerald-500 bg-clip-text text-transparent"
            >
            ...
            <div className="flex items-center gap-6">
              ...
              <motion.button
                ...
                onClick={() => signOut()}
                className="px-6 py-3 text-sm font-bold text-white bg-gradient-to-r from-[#07D348] to-emerald-500 rounded-xl hover:from-[#06b63e] hover:to-emerald-600 transition-all duration-300 shadow-lg hover:shadow-[#07D348]/40"
              >
                Sign Out
              </motion.button>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <motion.div
              ...
              className="bg-gray-900/70 backdrop-blur-2xl rounded-3xl p-8 border border-gray-800/50 shadow-2xl hover:shadow-[#07D348]/30"
            >
        ...
        >
          <div className="flex gap-4">
            <select
              ...
              className="bg-gray-900/80 border border-gray-800/50 text-gray-100 rounded-xl px-6 py-3 focus:ring-2 focus:ring-[#07D348] focus:border-[#07D348] hover:border-[#07D348]/60 transition-all duration-300 text-sm font-medium shadow-md"
            >
          ...
          <AnimatePresence>
            {filteredReports.map((report, index) => (
              <motion.div
                ...
                className="bg-gray-900/70 backdrop-blur-2xl rounded-3xl p-6 border border-gray-800/50 hover:border-[#07D348]/60 transition-all duration-300 shadow-2xl hover:shadow-[#07D348]/40 group will-change-transform"
              >
                <div className="space-y-5">
                  ...
                  <select
                    ...
                    className="w-full bg-gray-900/80 border border-gray-800/50 text-gray-100 rounded-xl px-6 py-3 focus:ring-2 focus:ring-[#07D348] focus:border-[#07D348] hover:border-[#07D348]/60 transition-all duration-300 text-sm font-medium shadow-md"
                  >
                    {Object.values(ReportStatus).map((status) => (
                      <option key={status} value={status}>
                        {status}
        ...
        {filteredReports.length === 0 && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.4 }}
            className="text-center py-16 text-gray-300 text-lg bg-gray-900/70 backdrop-blur-2xl rounded-3xl border border-gray-800/50 shadow-2xl hover:shadow-[#07D348]/30"
          >
